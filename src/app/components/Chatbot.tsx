...
export function Chatbot() {
  ...
  const handleSend = () => {
    if (message.trim()) {
      ...
      setTimeout(() => {
        const responses = {
          fr: "Je suis l'assistant CiviX. Je peux vous aider avec vos questions sur la démocratie participative. N'hésitez pas à cliquer sur les questions fréquentes pour obtenir des réponses détaillées.",
          de: "Ich bin der CiviX-Assistent. Ich kann Ihnen bei Fragen zur partizipativen Demokratie helfen. Zögern Sie nicht, auf die häufig gestellten Fragen zu klicken, um detaillierte Antworten zu erhalten.",
          en: "I'm the CiviX assistant. I can help you with your questions about participatory democracy. Feel free to click on the frequent questions to get detailed answers.",
        };
